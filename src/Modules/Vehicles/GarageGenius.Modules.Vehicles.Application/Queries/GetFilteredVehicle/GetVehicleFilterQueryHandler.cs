...
internal class GetVehicleFilterQueryHandler : IQueryHandler<GetVehicleFilterQuery, GetVehicleFilterQueryDto>
{
    ...
    {
        GetVehicleFilterQueryDto getVehicleFilterQueryDto = await _vehicleQueryStorage.GetFilteredVehicleAsync(query.GetVehicleFilterParameters, cancellationToken);
